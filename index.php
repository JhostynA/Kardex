                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form autocomplete="off" id="form-login">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputNomuser">Nombre de usuario</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassusuario" type="password" placeholder="Password" required />
                                                <label for="inputPassusuario">Contraseña</label>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="password.html">¿Olvidó su acceso?</a>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.html">Crear una nueva cuenta</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                document.querySelector("#form-login").addEventListener("submit", (event) => {
                    ...
                    fetch(`./controllers/colaboradores.controller.php?${params}`)
